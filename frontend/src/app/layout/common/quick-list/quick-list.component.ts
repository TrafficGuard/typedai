...
import { QuickListService } from 'app/layout/common/quick-list/quick-list.service';
import { Chat } from 'app/layout/common/quick-list/quick-list.types';
...
export class QuickListComponent implements OnInit, AfterViewInit, OnDestroy {
    ...
    constructor(
        ...
        private _quickChatService: QuickListService,
