...
import { Claude4_5_Opus_Vertex, Claude4_5_Haiku_Vertex, Claude4_5_Sonnet_Vertex } from '#llm/services/anthropic-vertex';
...
function pickLLM(modelName: string) {
	...
	if (modelName.includes('opus')) return Claude4_5_Opus_Vertex();
	return undefined;
}
