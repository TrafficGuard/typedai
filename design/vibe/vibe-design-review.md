...
When the status (VibeStatus in vibe.model.ts) is `file_selection_review` or `updating_file_selection` then vibe.component.html will display the vibe-file-list component.
