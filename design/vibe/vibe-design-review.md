...
When the status (VibeStatus in vibe.model.ts) is `design_review` or `updating_design` then vibe.component.html will display the vibe-design-review component.
