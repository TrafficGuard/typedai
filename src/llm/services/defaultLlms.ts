...
import { anthropicClaude4_5_Haiku, anthropicClaude4_5_Opus, anthropicClaude4_5_Sonnet } from '#llm/services/anthropic';
import { vertexGemini_2_5_Flash, vertexGemini_2_5_Flash_Lite, vertexGemini_2_5_Pro, vertexGemini_3_0_Pro } from '#llm/services/vertexai';
import { logger } from '#o11y/logger';
import type { AgentLLMs } from '#shared/agent/agent.model';
import type { LLM } from '#shared/llm/llm.model';
import { Claude4_5_Opus_Vertex, Claude4_5_Sonnet_Vertex } from './anthropic-vertex';
import { cerebrasGptOss_120b, cerebrasZaiGLM_4_6 } from './cerebras';
import { fireworksKimi2thinking } from './fireworks';
import { Gemini_2_5_Flash, Gemini_2_5_Flash_Lite, Gemini_2_5_Pro, Gemini_3_0_Pro } from './gemini';
...
export function defaultLLMs(): AgentLLMs {
	...
	const hardLLMs = [
		...
		anthropicClaude4_5_Opus(),
		Gemini_3_0_Pro(),
		vertexGemini_3_0_Pro(),
