import { defineRoute } from '#shared/api-definitions';
    import {
        ...
        AgentActionBaseSchema, // Using AgentActionBaseSchema
        AgentCancelRequestSchema,
        AgentResumeCompletedRequestSchema,
        AgentUpdateFunctionsRequestSchema,
        AgentDeleteRequestSchema,
        AgentActionByIdSchema, // Added for routes needing only agentId
    } from '../schemas/agent.schema';
    import { ApiNullResponseSchema } from '../schemas/common.schema';
    import { Type } from '@sinclair/typebox';
    import { AgentContext } from '../model/agent.model'; // Added import
    import { ChangePropertyType } from '#shared/typeUtils'; // Added import

    const AGENT_BASE_V1 = '/api/agent/v1';

// Re-added AgentContextApi type
