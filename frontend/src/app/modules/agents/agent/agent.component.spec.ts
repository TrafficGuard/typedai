...
const mockActivatedRoute = {
	...
	snapshot: {
		// Component uses toSignal(this.route.paramMap...) so snapshot might not be strictly needed for agentId signal
