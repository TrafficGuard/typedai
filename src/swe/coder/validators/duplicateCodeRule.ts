// Sometimes the coder adds code instead of replace.
// Need some heuristic, if there is lots of multiple lines of code that are identical, then its an error
// Could count the duplicate lines before/after?
