...
export function defaultLLMs(): AgentLLMs {
	...
	const easyLLMs = [new FastEasyLLM(), vertexGemini_2_5_Flash(), Gemini_2_5_Flash(), groqLlama4_Scout(), openaiGPT5nano(), anthropicClaude4_5_Haiku()];
